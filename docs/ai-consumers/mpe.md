...
# Page settings
layout: default
keywords: MPE, Payment Channel, Claiming funds, recipient Claims funds from the Channel
comments: false
title: MPE
description: An Escrow contract defines the conditional transaction between two transacting parties through an Escrow account.
