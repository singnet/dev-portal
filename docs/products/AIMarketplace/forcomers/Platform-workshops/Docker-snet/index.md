...
* local IPFS instance is deployed and started (see [deploy local IPFS
  instance](/docs/products/AIMarketplace/forcomers/local-singularitynet.md#deploy-local-ipfs-instance)
  and [start local IPFS
  instance](/docs/products/AIMarketplace/forcomers/local-singularitynet.md#start-local-ipfs-instance)
* Ganache instance is started with predefined network number and mnemonic to
  ...
  ethereum
  network](/docs/products/AIMarketplace/forcomers/local-singularitynet.md#start-local-ethereum-network));
...
* local Ethereum node and IPFS instance are added into snet-cli configuration
  [setup snet-cli
  interface](/docs/products/AIMarketplace/forcomers/local-singularitynet.md#setup-snet-command-line-interface);
...
In order to see full list of preparations you need to work with local Ethereum network you need to look at page [build and deploy SingularityNET locally](/docs/products/AIMarketplace/forcomers/local-singularitynet.md).
