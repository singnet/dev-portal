...
Organization metadata is described in detail [here](/docs/products/AIMarketplace/forcomers/organization.md).
...
* Service metata is described in detail [here](/docs/products/AIMarketplace/coreconcepts/Marketplace-ecosystem/service.md).
