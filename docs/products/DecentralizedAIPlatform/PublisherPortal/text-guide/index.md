...
![Registration](/assets/images/products/AIMarketplace/publisher/RegistrationOfOrganization.png)
...
![Description](/assets/images/products/AIMarketplace/publisher/DescriptionOfOrganization.png)
...
![Payment Address](/assets/images/products/AIMarketplace/publisher/PaymentAddress.png)
...
![Publishing Organization to Blockchain](/assets/images/products/AIMarketplace/publisher/PublishOrganizationToBlockchain.png)
...
<img src="/assets/images/products/AIMarketplace/publisher/MetamaskConfirmation.png" style="width:40%">

## How to create a service?

![Creating New Service](/assets/images/products/AIMarketplace/publisher/CreatingNewService.png)
...
![Service Profile Information](/assets/images/products/AIMarketplace/publisher/AIServiceProfileInformation.png)
...
![Tags](/assets/images/products/AIMarketplace/publisher/ServiceTags.png)
...
![Price](/assets/images/products/AIMarketplace/publisher/PublishOrganizationToBlockchain.png)
...
![Proto](/assets/images/products/AIMarketplace/publisher/UploadingTheProtoFiles.png)
17. Waiting...
...
![Infura HomePage](/assets/images/products/AIMarketplace/publisher/InfuraHomePage.png)
2. After visiting the Infura homepage, you will already have one generated API key, you can copy it
![Infura Key](/assets/images/products/AIMarketplace/publisher/InfuraKey.png)
...
![Daemon Config](/assets/images/products/AIMarketplace/publisher/CreatingDaemonConfig.png)
...
![Download Daemon](/assets/images/products/AIMarketplace/publisher/DownloadDaemon.png)
...
screen -S YourName
![Screen](/assets/images/products/AIMarketplace/publisher/ChmodAndScreenCommands.png)
4. Start Daemon in this session
./snetd-linux-amd64-v5.1.3 -c snetd.config.json
![Config](/assets/images/products/AIMarketplace/publisher/ConfigPowershell  .png)
