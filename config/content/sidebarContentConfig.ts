...
export const PlatformSection: DefaultTheme.SidebarItem[] = [
    ...
    },
    {
        ...
        link: "/docs/products/DecentralizedAIPlatform/getting-started/",
        collapsed: true,
        items: [
            {
            ...
            {
                text: "For AI Consumers",
                link: "/docs/products/DecentralizedAIPlatform/getting-started/for-consumers/",
            },
            {
                text: "For AI Developers",
                link: "/docs/products/DecentralizedAIPlatform/getting-started/for-developers/",
            },
        ],
    },
    {
        text: "Quick Start Guides",
        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/",
        collapsed: true,
        items: [
            {
                text: "For Consumers",
                link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/",
                collapsed: true,
                items: [
                    {
                        text: "Getting Ready to Call AI",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/getting-ready-to-call-ai/",
                    },
                    {
                        text: "Calling via Marketplace",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/calling-via-marketplace/",
                    },
                    {
                        text: "Calling via CLI",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/calling-via-cli/",
                    },
                    {
                        text: "Calling via TUI",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/calling-via-tui/",
                    },
                    {
                        text: "Calling via SDK",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/calling-via-sdk/",
                    },
                    {
                        text: "Service Training",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/consumers/service-training/",
                    },
                ],
            },
            {
                text: "For Developers",
                link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/",
                collapsed: true,
                items: [
                    {
                        text: "Getting Ready to Onboard",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/getting-ready-to-onboard/",
                    },
                    {
                        text: "Publishing Methods Comparison",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/publishing-methods-comparison/",
                    },
                    {
                        text: "Complete Onboarding Guide",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/complete-onboarding-guide/",
                    },
                    {
                        text: "Onboarding via Publisher",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/onboarding-via-publisher/",
                    },
                    {
                        text: "Onboarding via CLI",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/onboarding-via-cli/",
                    },
                    {
                        text: "Onboarding via TUI",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/onboarding-via-tui/",
                    },
                    {
                        text: "GRPC Service Integration",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/grpc-service-integration/",
                    },
                    {
                        text: "HTTP Service Integration",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/http-service-integration/",
                    },
                    {
                        text: "Training Service Integration",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/training-service-integration/",
                    },
                    {
                        text: "Creating UI for Service",
                        link: "/docs/products/DecentralizedAIPlatform/QuickStartGuides/developers/creating-ui-for-service/",
                    },
                ],
            },
        ],
    ...
    {
        text: "Tools",
        link: "/docs/products/DecentralizedAIPlatform/Tools/",
        collapsed: true,
        items: [
            {
                text: "Daemon",
    ...
    {
        text: "Service UI",
        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/",
        collapsed: true,
        items: [
            {
                text: "UI Sandbox",
                link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/",
                collapsed: true,
                items: [
                    {
                    ...
                    },
                    {
                        ...
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/interface-overview/"
                    },
                    {
                        text: "How to use UI Sandbox version 2 (new)",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/version-2/",
                    },
                    {
                        text: "Templates overview",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/templates-overview/",
                    },
                    {
                        text: "Guidelines",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/guidelines/calculator-guide/",
                        collapsed: true,
                        items: [
                            {
                            ...
                            },
                            {
                                ...
                                link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/guidelines/using-templates/",
                            },
                        ],
                    },
                    {
                        text: "How to use UI Sandbox version 1 (old)",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/version-1/",
                    },
                    {
                        text: "FAQ",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/sandbox/faq/",
                    }
                ],
            },
            {
                text: "UI Boilerplate",
                link: "/docs/products/DecentralizedAIPlatform/ServiceUI/boilerplate/",
                collapsed: true,
                items: [
                    {
                    ...
                    { 
                        text: "Getting Started",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/boilerplate/getting-started/",
                    },
                    { 
                        text: "Using guide",
                        link: "/docs/products/DecentralizedAIPlatform/ServiceUI/boilerplate/user-guide/",
                    }
                ],
            },
        ],
